jQuery.sap.declare("sap.ui.demo.explored.resource.DataGenerator");

sap.ui.demo.explored.resource.DataGenerator = {};

sap.ui.demo.explored.resource.DataGenerator.gen = function (oData) {
...
(function () {
	...
	jQuery.ajax("products.json", {
		...
		success: function (data) {
			sap.ui.demo.explored.resource.DataGenerator.gen(data);
		},
		error: function () {
